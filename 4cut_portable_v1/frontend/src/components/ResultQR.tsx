...
export default function ResultQR({ url, imagePreview }: ResultQRProps) {
  if (!url) return null;
      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-10 items-start">
        ...
        <div className="flex-1 flex flex-col items-center text-center">
          ...
          <button 
            ...
            className="px-10 py-5 bg-white text-black text-xl rounded-full font-bold hover:bg-zinc-200 transition-colors w-full max-w-sm shadow-lg"
          >
            처음부터 다시 촬영하기
          </button>
        </div>
